"""Люба Bot Configuration — loaded from environment variables."""
import os
...
class BotConfig:
    ...
    BOT_USERNAME: str = field(default_factory=lambda: _env("BOT_USERNAME", "@asluba_bot"))
    ...
    GH_REPO: str = field(default_factory=lambda: _env("GH_REPO", "sochiautoparts/luba"))
    ...
    PARTNER_REFRESH_HOURS: int = field(default_factory=lambda: int(_env("PARTNER_REFRESH_HOURS", "6")))
    ...
    RECOMMEND_CHANNELS: List[str] = field(default_factory=lambda: ["https://t.me/sochiautoparts", "https://t.me/bmw_mpower_club"])
    SHOP_URL: str = field(default_factory=lambda: _env("SHOP_URL", "https://sochiautoparts.ru/shop"))
    SITE_URL: str = field(default_factory=lambda: _env("SITE_URL", "https://sochiautoparts.ru"))
